...
namespace GeolocalisationFO_Shared
{
    public class Constants
    {
        ...
        public static readonly String VerifyTechnicianLoginURL = "http://" + IPAddress + ":" + Port + "/api/GeolocalisationFO/VerifyTechnicianLogin";
        ...
        public static readonly String UpdateTaskURL = "http://" + IPAddress + ":" + Port + "/api/GeolocalisationFO/UpdateTaskFinished";
    }
}